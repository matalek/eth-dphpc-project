...
pair<int, int> findLowerT(ConvexHullRepresentation &left_hull, ConvexHullRepresentation &right_hull) {
    ...
    left_iter = binary_right_upper_tangent(left_hull, left_iter, left_hull.find_leftmost_point(), right_iter->get_point());
    right_iter = binary_left_upper_tangent(right_hull, right_iter, right_hull.find_rightmost_point(), left_iter->get_point());
...
pair<int, int> findUpperT(ConvexHullRepresentation &left_hull, ConvexHullRepresentation &right_hull) {
    ...
    left_iter = binary_left_upper_tangent(left_hull, left_iter, left_hull.find_leftmost_point(), right_iter->get_point());
    right_iter = binary_right_upper_tangent(right_hull, right_iter, right_hull.find_rightmost_point(), left_iter->get_point());
