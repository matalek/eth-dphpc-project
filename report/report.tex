...
We want to investigate parallel algorithms for sorted input in PRAM (Parallel Random Access Machine), implement them and compare them. It is important to distinguish between a convex hull problem with sorted or unsorted input, because they have different sequential complexity: $O(n)$ and $O(n\log n)$ respectively.
