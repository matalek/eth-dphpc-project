...
All of them are designed to solve Convex hull problem for sorted input.
  
\section{Background: Whatever the Background is}\label{sec:background}

\mypar{Convex polygon} is defined as a polygon with all its interior angles less than 180°.
